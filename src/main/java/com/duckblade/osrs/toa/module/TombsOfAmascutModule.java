...
import com.duckblade.osrs.toa.features.nexus.DepositBoxFilter;
import com.duckblade.osrs.toa.features.nexus.DepositBoxFilterOverlay;
import com.duckblade.osrs.toa.features.nexus.HelpfulSpiritHighlighter;
...
public class TombsOfAmascutModule extends AbstractModule
{
	...
	Set<PluginLifecycleComponent> lifecycleComponents(
		...
		ApmekenWaveOverlay apmekenWaveOverlay,
		...
		IgnoreListPartyBoardHighlighter ignoreListPartyBoardHighlighter,
	...
	)
	{
		return ImmutableSet.of(
			...
			hetSolverOverlay,
			hpOrbManager,
			ignoreListPartyBoardHighlighter,
